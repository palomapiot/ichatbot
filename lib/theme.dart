...
final theme = ThemeData(
  primaryColor: MaterialColor(0xFF5A17EE, themeColor),
  ...
  colorScheme: ColorScheme.fromSwatch(
    primarySwatch: MaterialColor(0xFF5A17EE, themeColor),
    accentColor: themeColor[900],
  ).copyWith(secondary: MaterialColor(0xFF5A17EE, themeColor)),
);
